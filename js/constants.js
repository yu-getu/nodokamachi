...
// スキルツリー定義（3列×12段）
const SKILLS = [
  // ── 左列：生産強化 ──（全エリアCPS → 全体乗算）
  {id:'farm_mastery',    name:'大地の恵み',      emoji:'🥕', cost:1, tier:1,  requires:[],                   effect:'cps_area1',       value:0.20,  desc:'農村エリア全建物のCPS +20%'},
  {id:'commerce_art',    name:'商いの才',         emoji:'🏪', cost:1, tier:2,  requires:['farm_mastery'],     effect:'cps_area2',       value:0.20,  desc:'商店街エリア全建物のCPS +20%'},
  {id:'culture_mastery', name:'文化の極み',       emoji:'🎭', cost:2, tier:3,  requires:['commerce_art'],     effect:'cps_area3',       value:0.30,  desc:'文化の丘エリア全建物のCPS +30%'},
  {id:'healing_spirit',  name:'癒やしの精神',     emoji:'🌿', cost:2, tier:4,  requires:['culture_mastery'],  effect:'cps_area4',       value:0.30,  desc:'癒やしエリア全建物のCPS +30%'},
  {id:'city_dream',      name:'都市の夢',         emoji:'🏙️', cost:3, tier:5,  requires:['healing_spirit'],   effect:'cps_area5',       value:0.30,  desc:'娯楽エリア全建物のCPS +30%'},
  {id:'space_ambition',  name:'宇宙への野望',     emoji:'🚀', cost:3, tier:6,  requires:['city_dream'],       effect:'cps_area6',       value:0.40,  desc:'宇宙エリア全建物のCPS +40%'},
...
const ACHIEVEMENTS = [
  ...
  {id:'rapid_harvest', icon:'⚡', name:'落ち着きのない人', desc:'30秒以内にひと稼ぎを150回押した',    reward:'称号', hidden:true, cat:'hidden',    check:s=>s.rapidHarvested},
